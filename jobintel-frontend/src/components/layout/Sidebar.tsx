...
const NAV_ITEMS = [
  ...
  { label: "HubSpot CRM", path: "/hubspot", icon: Link2 },
  { label: "Master Job Table", path: "/jobs", icon: Briefcase },
  { label: "Scrapers", path: "/scrapers", icon: Cpu },
  { label: "Actors", path: "/actors", icon: Cpu },
];
    ...
    <aside className="fixed left-0 top-0 h-screen w-[240px] flex-col border-r border-border-default bg-bg-surface px-4 py-6 flex">
      <div className="mb-8 flex items-center px-2">
        ...
        <h1 className="text-xl font-bold text-text-primary tracking-tight">
          JobIntel<span className="text-accent-primary">.</span>
        </h1>
      </div>
