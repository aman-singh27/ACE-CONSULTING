...
import { getHubSpotSyncStatus, triggerHubSpotSync, setupHubSpotProperties, recordSyncHistory } from "../../services/api/hubspot";
import { Button } from "../ui/Button";
import { Card, CardContent, CardHeader, CardTitle } from "../ui/Card";
import { Loader2, RefreshCw, Settings, CheckCircle, XCircle, Clock } from "lucide-react";
            ...
            <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <span className={`font-medium ${getStatusColor(status?.status || 'idle')}`}>
                ...
                {status?.next_scheduled && (
                    <div className="text-xs text-gray-500 pt-2 border-t">
                        Next scheduled sync: {new Date(status.next_scheduled).toLocaleString()}
                    </div>
                )}
            </CardContent>
        </Card>
